...
export const LIST_SCHEMA = {
  history: {
    ...
    newItem: () => ({ year: '', titleKo: '', titleEn: '', itemsKo: [], itemsEn: [] }),
    fields: [
      { key: 'year', label: '연도', type: 'plain', placeholder: '예: 2026' },
      { key: 'title', label: '연도 제목 (없으면 비워두세요)', type: 'text' },
  ...
  businessCards: {
    ...
    newItem: () => ({ id: `card-${Date.now()}`, titleKo: '', titleEn: '', descKo: '', descEn: '', imgKr: '', imgEn: '' }),
    fields: [
      { key: 'title', label: '명함 제목', type: 'text' },
